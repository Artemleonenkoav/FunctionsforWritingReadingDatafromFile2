...
// Служба доставки пиццы обрабатывает заказы в порядке живой очереди. После того, как клиент оплатил свой заказ, он добавляется в онлайн-лист ожидания. После того, как пицца готова, информация передается курьеру, сохраняется в файл и удаляется из списка ожидания. Отображение количества клиентов, ожидающих заказа в данный момент. (Подсказка: для реализации задачи на C используйте структуру, описывающую понятие заказа, со свойствами: имя посетителя, адрес доставки, заказ, общая стоимость. Заказ записывается из листа ожидания в файл, когда он удален).
//
//Ожидаемый функционал:
//
//Введите информацию (имя клиента, адрес, заказ, общая стоимость).
//Записать в файл – удалить данные заказа.
//Отображение количества клиентов, ожидающих заказа (имя клиента, адрес, общая стоимость).
